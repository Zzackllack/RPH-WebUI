    ...
    return (
        <html lang="en" className="scroll-smooth">
            <head>
                ...
                <meta property="og:description" content="Host, share, and use your Minecraft resource packs on your server" />
                ...
                <meta name="twitter:description" content="Host, share, and use your Minecraft resource packs on your server" />
