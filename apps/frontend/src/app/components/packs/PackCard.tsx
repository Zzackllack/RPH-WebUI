...
export function PackCard({ pack, onDelete }: PackCardProps) {
  ...
  // Removed showHash logic, now handled in ShowDetailsButton
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        ...
        {/* Replaced Show Hash button with ShowDetailsButton */}
        <ShowDetailsButton pack={pack} />
      </div>

      {/* Hash Modal removed, now handled in ShowDetailsButton */}
    </motion.div>
  );
}
