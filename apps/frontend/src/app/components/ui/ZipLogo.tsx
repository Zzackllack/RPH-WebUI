...
export const ZipLogo: React.FC<{ className?: string }> = ({ className }) => (
    <svg
    ...
    >
        ...
        >
            <stop offset=".233" stopColor="#41a5ee"></stop>
            <stop offset=".317" stopColor="#3994de"></stop>
            <stop offset=".562" stopColor="#2366b4"></stop>
            <stop offset=".751" stopColor="#154a9b"></stop>
            <stop offset=".86" stopColor="#103f91"></stop>
        </linearGradient>
        <rect
            width="36"
            height="12"
        ...
        <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
        >
            <stop offset=".233" stopColor="#e8457c"></stop>
            <stop offset=".272" stopColor="#e14177"></stop>
            <stop offset=".537" stopColor="#b32c59"></stop>
            <stop offset=".742" stopColor="#971e46"></stop>
            <stop offset=".86" stopColor="#8c193f"></stop>
        </linearGradient>
        <path
        ...
        <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
        >
            <stop offset=".233" stopColor="#33c481"></stop>
            <stop offset=".325" stopColor="#2eb173"></stop>
            <stop offset=".566" stopColor="#228353"></stop>
            <stop offset=".752" stopColor="#1b673f"></stop>
            <stop offset=".86" stopColor="#185c37"></stop>
        </linearGradient>
        <path
        ...
        <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
        >
            <stop offset=".039" stopColor="#f8c819"></stop>
            <stop offset=".282" stopColor="#af4316"></stop>
        </linearGradient>
        <rect
            width="12"
            height="36"
        ...
        <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
        >
            <stop offset="0" stopColor="#eaad29"></stop>
            <stop offset=".245" stopColor="#d98e24"></stop>
            <stop offset=".632" stopColor="#c0631c"></stop>
            <stop offset=".828" stopColor="#b75219"></stop>
            <stop offset=".871" stopColor="#a94917"></stop>
            <stop offset=".949" stopColor="#943b13"></stop>
            <stop offset="1" stopColor="#8c3612"></stop>
        </linearGradient>
        <path
        ...
        <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
        >
            <stop offset=".613" stopColor="#e6e6e6"></stop>
            <stop offset=".785" stopColor="#e4e4e4"></stop>
            <stop offset=".857" stopColor="#ddd"></stop>
            <stop offset=".91" stopColor="#d1d1d1"></stop>
            <stop offset=".953" stopColor="#bfbfbf"></stop>
            <stop offset=".967" stopColor="#b8b8b8"></stop>
        </linearGradient>
        <path
