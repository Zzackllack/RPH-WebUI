...
[servers.${serverName}.version.${c.packFormat}]
    ...
    const handleGenerate = () => {
        ...
        onConfigGenerated(
            config,
            mode,
            mode === "server" ? serverName : undefined
        );
        addToast({
            type: "success",
        ...
        if (step === "intro") setStep("mode");
            ...
            if (!serverName.trim()) {
                addToast({
                    ...
                    message:
                        "Please enter a valid server name before proceeding.",
                });
                return;
            }
            setStep("review");
                                  ...
                                  >
                                      ...
                                      <div>
                                          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">
                                              Welcome to ForcePack
                                              Configuration!
                                          </h3>
                                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                                              ForcePack is a powerful plugin
                                              that automatically sends resource
                                              packs to players when they join
                                              your server. This wizard will help
                                      ...
                                      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                                          <p className="text-sm text-blue-800 dark:text-blue-200">
                                              💡 <strong>Tip:</strong>{" "}
                                              You&apos;ll need to have ForcePack
                                              installed on your server for this
                                              ...
                                              <div className="flex items-start gap-4">
                                                  ...
                                                  <div>
                                                      ...
                                                      <p className="text-sm text-gray-600 dark:text-gray-400">
                                                          Apply to a specific
                                                          server with support
                                                          for multiple converted
                                                          versions. Players with
                                                          different Minecraft
                                                          versions will get
                                                          compatible packs.
                                                      </p>
                                  ...
                                  >
                                      <div className="text-center">
                                          ...
                                          <p className="text-gray-600 dark:text-gray-400">
                                              Enter the name identifier for your
                                              server. This should match the
                                              server name in your network
                                              configuration.
                                          </p>
                                      </div>
                                  ...
                                  >
                                      ...
                                      <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-4">
                                          <p className="text-sm text-emerald-800 dark:text-emerald-200">
                                              ...
                                              configuration will be created and
                                              displayed for you to copy into
                                              your ForcePack config file.
                                          </p>
                                      </div>
                                  </motion.div>
                              )}
